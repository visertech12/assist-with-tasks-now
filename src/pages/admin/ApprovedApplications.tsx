    ...
    <Card className="bg-zinc-900 border-zinc-800 mb-4">
      <CardContent className="pt-4 space-y-2">
        <div className="flex justify-between items-center">
          ...
          <Badge variant="secondary" className="bg-green-500/20 text-green-500 border-green-500/40">
            {app.status}
          </Badge>
        </div>
    ...
    <AdminLayout>
      <div className="p-4 md:p-6">
        <div className="flex justify-between items-center mb-4 md:mb-6">
          <h1 className="text-xl md:text-2xl font-bold text-white">Approved Applications</h1>
          <Button 
            variant="outline" 
            size="sm" 
        ...
        {isLoading ? (
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-6 text-center">
            <p className="text-zinc-400">No approved applications found</p>
          </div>
        ) : isMobile ? (
          <div className="space-y-2">
